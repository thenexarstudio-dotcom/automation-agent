...
Gumroad lets you customize the receipt message per product ("Content" → receipt/thank-you note). These double as the first line of support — they pre-answer the questions buyers actually have, so the chat widget and your inbox stay quiet.

---

## Kit — receipt message

Thanks for picking up the Consultant Client Ops Kit!

**Start with the START-HERE.md file** in your download — it covers importing the editable markdown versions into Notion (Import → Text & Markdown) or Google Docs in about two minutes.
...
## Refund reply (keep handy, don't automate)

Sorry it wasn't the right fit — refund's on its way (you'll see it from Gumroad within a few business days).

If you're willing: one sentence on what you expected that wasn't there would genuinely help me improve the product. Either way, thanks for giving it a look.
